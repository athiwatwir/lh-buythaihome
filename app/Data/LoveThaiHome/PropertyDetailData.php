...
readonly class PropertyDetailData
{
    ...
    public function toPropertyData(): PropertyData
    {
        return PropertyData::fromArray([
            ...
            'is_special_price' => $this->isSpecialPrice,
            'price_special' => $this->priceSpecial,
    ...
    public function galleryImages(): array
    {
        ...
        if ($images === []) {
            ...
            //return [asset('images/cover/no-image.webp')];
            return [];
        }
    ...
    {
        return $this->toPropertyData()->hasSpecialPrice();
    }

    public function formattedSalePrice(): string
    {
        return $this->toPropertyData()->formattedSalePrice();
    }

    public function formattedSpecialSalePrice(): string
    {
        return $this->toPropertyData()->formattedSpecialSalePrice();
    }

    public function formattedPriceRent(): ?string
    {
        return $this->toPropertyData()->formattedPriceRent();
    }
    ...
    {
        return RichHtml::render($this->description);
    }
