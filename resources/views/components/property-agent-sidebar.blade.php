...
<aside class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm lg:sticky lg:top-24">
    ...
    <div class="mt-6 space-y-3">
        ...
        @if ($user->id)
        <a href="{{ route('properties.index', ['user_id' => $user->id]) }}" class="flex items-center justify-center gap-2 rounded-xl border-2 border-blue-200 bg-linear-to-r from-blue-50 to-indigo-50 px-4 py-3 text-sm font-semibold text-blue-800 transition hover:border-blue-400 hover:from-blue-100 hover:to-indigo-100">
